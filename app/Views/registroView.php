...
<div class="columns">
    ...
    <div class="column is-narrow">
        ...
        <section id="btnEditarPerfil" class="hero is-small is-link mb-4">
            <div class="hero-body">
                <p class="title">¡YA CASI ESTAS!</p>
                <p class="subtitle">Completa el formulario</p>
            </div>
        </section>
    </div>

    <!-- Contenedor con el fondo dinámico -->
    <div id="bckgFade" class="column">
        <div class="columns">
            <div class="column is-8 is-offset-2">
                ...
                <div class="box">
                    <form action="<?= base_url('registro/registrar'); ?>" method="post">
                        ...
                        <div class="field">
                            <div class="control">
                                <button class="button is-link is-fullwidth">Registrar</button>
                            </div>
                        </div>
                    </form>
                </div>
